...
function textChange(game){
    ...
    if (game == 'apex'){
        texto.innerHTML =
            ...
            +" \nVocê e seu esquadrão conseguem ser os Campeões da Arena?";
        
            players.innerHTML = "3 jogadores";
        ...
        players.innerHTML = "1 - 4 jogadores";
    }
